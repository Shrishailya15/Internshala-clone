...
function InternDeatil() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const response = await axios.get(`https://internshala-clone-89d6.onrender.com/api/internship/${id}`)
  ...
  const submitApplication = async () => {
    ...
    if (text.value === "") {
      ...
      await axios.post("https://internshala-clone-89d6.onrender.com/api/application", bodyJson).then((res) => {
  ...
  //payment handling and resume uploadation to the mongodb
  const handlePaymentAndSubmit = async (e) => {
    e.preventDefault();
  
    try {
      // Step 1: Create an order on your backend
      const response = await axios.post('https://internshala-clone-89d6.onrender.com/api/rasorpay/checkout', {
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            ...
            const verificationResponse = await axios.post('https://internshala-clone-89d6.onrender.com/api/rasorpay/paymentverification', {
          ...
          try {
            ...
            await axios.post('https://internshala-clone-89d6.onrender.com/api/resume', data);
