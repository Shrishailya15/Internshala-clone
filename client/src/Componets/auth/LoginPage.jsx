 ...
 items-center h-9 justify-center mt-4 text-white bg-slate-100 rounded-lg hover:bg-gray-100' >
                                            ...
                                            <form onSubmit={login}>
                                                <div class="mt-4">
                                                    ...
                                                    <input id='email' value={emaill} onChange={(e) => setEmaill(e.target.value)} class=" text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" type="email" placeholder='john@example.com' />
                                                </div>
                                                <div class="mt-4">
                                                    ...
                                                    <input value={passwordd} onChange={(e) => setPasswordd(e.target.value)} class=" text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none" placeholder='Must be atleast 6 characters' type="text" id='password' />
                                                </div>
                                                <div className="mt-8">
